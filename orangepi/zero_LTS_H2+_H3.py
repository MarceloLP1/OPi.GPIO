...
Alternative pin mappings for Orange PI Zero LTS H2+/H3
see: http://www.orangepi.org/html/hardWare/computerAndMicrocontrollers/service-and-support/Orange-Pi-Zero-LTS.html

(see schematics drive:  https://drive.google.com/drive/folders/1kmPudPO9dENdBm_Z1IHar8vu_lmzNXFR)

Usage:

.. code:: python
   import orangepi.zero_lts_H2+_H3
   from OPi import GPIO

   GPIO.setmode(orangepi.zero_lts_H2+_H3.BOARD) or GPIO.setmode(orangepi.zero_lts_H2+_H3.BCM)
"""

# pin number = (position of letter in alphabet - 1) * 32 + pin number
# So, PD14 will be (4 - 1) * 32 + 14 = 110

# Orange Pi Zero LTS H2+/H3 physical board pin to GPIO pin
BOARD = {
...
# Orange Pi Zero LTS H2+/H3 BCM pin to actual GPIO pin
BCM = {
